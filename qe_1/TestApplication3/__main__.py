...
from .test_application3 import TestApplication3

# defaults
default_name = "TestApplication3"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication3",
    prog="TestApplication3",
