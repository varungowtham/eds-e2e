...
from .test_application4 import TestApplication4

# defaults
default_name = "TestApplication4"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication4",
    prog="TestApplication4",
