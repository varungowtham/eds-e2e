...
from .test_application8 import TestApplication8

# defaults
default_name = "TestApplication8"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication8",
    prog="TestApplication8",
