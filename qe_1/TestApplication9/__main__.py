...
from .test_application9 import TestApplication9

# defaults
default_name = "TestApplication9"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication9",
    prog="TestApplication9",
