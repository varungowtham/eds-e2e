...
from .test_application7 import TestApplication7

# defaults
default_name = "TestApplication7"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication7",
    prog="TestApplication7",
