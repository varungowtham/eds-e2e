...
from .test_application1 import TestApplication1

# defaults
default_name = "TestApplication1"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication1",
    prog="TestApplication1",
...
poas = config.get("poas", ["http://auto:23225"])
