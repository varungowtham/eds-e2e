...
from .test_application2 import TestApplication2

# defaults
default_name = "TestApplication2"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called TestApplication2",
    prog="TestApplication2",
